...
# Module imports
from qlcv.utils.html_processor import strip_tags
from qlcv.db.mixins import SoftDeletionManager
from qlcv.utils.exception_logger import log_exception
from .project import ProjectBaseModel
from qlcv.utils.uuid import convert_uuid_to_integer
from .description import Description
from qlcv.db.mixins import ChangeTrackerMixin
...
class Issue(ProjectBaseModel):
    ...
    def save(self, *args, **kwargs):
        if self.state is None:
            try:
                from qlcv.db.models import State
