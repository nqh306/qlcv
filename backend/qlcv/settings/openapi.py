...
SPECTACULAR_SETTINGS = {
    ...
    "CONTACT": {
        "name": "QLCV EVNGENCO1",
        "url": "https://ems.evngenco1.vn/qlcv",
        "email": "qlcv@evngenco1.vn",
    },
    "VERSION": "0.0.1",
    "LICENSE": {
        "name": "GNU AGPLv3",
        "url": "https://ems.evngenco1.vn/qlcv/blob/preview/LICENSE.txt",
    },
    # ========================================================================
    ...
    # ========================================================================
    "PREPROCESSING_HOOKS": [
        "qlcv.utils.openapi.hooks.preprocess_filter_api_v1_paths",
    ],
    # ========================================================================
    ...
    "SERVERS": [
        ...
        {"url": "https://ems.evngenco1.vn/qlcv/api", "description": "Production"},
    ],
    # ========================================================================
    # API Tag Definitions
    # ========================================================================
    ...
    "AUTHENTICATION_WHITELIST": [
        "qlcv.api.middleware.api_authentication.APIKeyAuthentication",
    ],
    # ========================================================================
    ...
    "ENUM_NAME_OVERRIDES": {
        "ModuleStatusEnum": "qlcv.db.models.module.ModuleStatus",
        "IntakeWorkItemStatusEnum": "qlcv.db.models.intake.IntakeIssueStatus",
    },
}
