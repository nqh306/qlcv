...
# Module imports
from qlcv.utils.url import is_valid_url
...
MIDDLEWARE = [
    ...
    "qlcv.authentication.middleware.session.SessionMiddleware",
    ...
    "qlcv.middleware.request_body_size.RequestBodySizeLimitMiddleware",
    "qlcv.middleware.logger.APITokenLogMiddleware",
    "qlcv.middleware.logger.RequestLoggerMiddleware",
]
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "qlcv.authentication.adapter.exception.auth_exception_handler",
...
WSGI_APPLICATION = "qlcv.wsgi.application"
ASGI_APPLICATION = "qlcv.asgi.application"
...
if os.environ.get("ENABLE_READ_REPLICA", "0") == "1":
    ...
    # Database Routers
    DATABASE_ROUTERS = ["qlcv.utils.core.dbrouters.ReadReplicaRouter"]
    # Add middleware at the end for read replica routing
    MIDDLEWARE.append("qlcv.middleware.db_routing.ReadReplicaRoutingMiddleware")
...
STORAGES["default"] = {"BACKEND": "qlcv.settings.storage.S3Storage"}
...
CELERY_IMPORTS = (
    # scheduled tasks
    "qlcv.bgtasks.issue_automation_task",
    "qlcv.bgtasks.exporter_expired_task",
    "qlcv.bgtasks.file_asset_task",
    "qlcv.bgtasks.email_notification_task",
    "qlcv.bgtasks.cleanup_task",
    "qlcv.license.bgtasks.tracer",
    # management tasks
    "qlcv.bgtasks.dummy_data_task",
    # issue version tasks
    "qlcv.bgtasks.issue_version_sync",
    "qlcv.bgtasks.issue_description_version_sync",
)
...
SESSION_ENGINE = "qlcv.db.models.session"
...
CSRF_FAILURE_VIEW = "qlcv.authentication.views.common.csrf_failure"
