...
from qlcv.license.api.permissions import InstanceSuperAdminPermission
from qlcv.license.models import InstanceConfiguration
from qlcv.license.api.serializers import InstanceConfigurationSerializer
from qlcv.license.utils.encryption import encrypt_data
from qlcv.utils.cache import cache_response, invalidate_cache
from qlcv.license.utils.instance_value import get_email_configuration


class InstanceConfigurationEndpoint(BaseAPIView):
    permission_classes = [InstanceSuperAdminPermission]
...
class EmailCredentialCheckEndpoint(BaseAPIView):
    def post(self, request):
        ...
        subject = "Email Notification từ QLCV"
        message = "This is a sample email notification sent từ QLCV application."
        # Send the email
        try:
