...
from qlcv.bgtasks.user_activation_email_task import user_activation_email

# Module imports
from qlcv.db.models import FileAsset, Profile, User, WorkspaceMemberInvite
...
class Adapter:
    ...
    def __init__(self, request, provider, callback=None):
        ...
        self.user_data = None
        self.logger = logging.getLogger("qlcv.authentication")
