...
from qlcv.db.models.workspace import WorkspaceHomePreference
from qlcv.app.permissions import allow_permission, ROLE
from qlcv.db.models import Workspace
from qlcv.app.serializers.workspace import WorkspaceHomePreferenceSerializer
...
class WorkspaceHomePreferenceViewSet(BaseAPIView):
    ...
    def get(self, request, slug):
        ...
        keys = [
            ...
            if key not in ["quick_tutorial", "new_at_qlcv"]
        ]
