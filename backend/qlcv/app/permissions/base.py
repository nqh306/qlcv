...
from qlcv.db.models import WorkspaceMember, ProjectMember
...
def allow_permission(allowed_roles, level="PROJECT", creator=False, model=None):
    def decorator(view_func):
        ...
        def _wrapped_view(instance, request, *args, **kwargs):
            # Workspace Admin bypass: WorkspaceMember role=20 has full access on every project in their workspace.
            # Applies to both WORKSPACE and PROJECT level checks.
            ...
            # Check for creator if required (creator can act on their own object)
