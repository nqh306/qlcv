...
from qlcv.app.serializers.workspace import WorkspaceLiteSerializer
from qlcv.app.serializers.user import UserLiteSerializer, UserAdminLiteSerializer
...
from qlcv.utils.content_validator import (
