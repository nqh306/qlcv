...
const helpOptions = [
  {
    name: "Documentation",
    href: "https://ems.evngenco1.vn/qlcv",
    Icon: PageIcon,
  },
  {
    name: "Join our Forum",
  ...
  {
    name: "Report a bug",
    href: "https://ems.evngenco1.vn/qlcv/issues/new/choose",
    Icon: GithubIcon,
  },
];
  ...
  return (
    ...
    >
      <div className={`flex items-center gap-1 ${isSidebarCollapsed ? "flex-col justify-center" : "w-full"}`}>
        <Tooltip tooltipContent="Redirect đến QLCV" position="right" className="ml-4" disabled={!isSidebarCollapsed}>
          <a
          ...
          >
            ...
            {!isSidebarCollapsed && "Redirect đến QLCV"}
          </a>
        </Tooltip>
