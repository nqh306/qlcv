...
import { validateSlug, validateWorkspaceName } from "@qlcv/utils";
// components
import { CustomSelect, Input } from "@qlcv/ui";
// hooks
          ...
          await createWorkspace(formData)
            .then(async () => {
              setToast({
                ...
                message: t("admin.page.users.toast.created_success"),
              });
            ...
            .catch(() => {
              setToast({
                ...
                message: t("admin.page.users.toast.created_error"),
              });
            });
    ...
    <div className="space-y-8">
      <div className="grid-col grid w-full max-w-4xl grid-cols-1 items-start justify-between gap-x-10 gap-y-6 lg:grid-cols-2">
        <div className="flex flex-col gap-1">
          <h4 className="text-13 text-tertiary">{t("admin.page.organizations.name_label")}</h4>
          <div className="flex flex-col gap-1">
            <Controller
              control={control}
              name="name"
              ...
              render={({ field: { value, ref, onChange } }) => (
                <Input
                  ...
                  placeholder={t("admin.page.organizations.name_placeholder")}
                  className="w-full"
                />
              )}
            />
        ...
        <div className="flex flex-col gap-1">
          <h4 className="text-13 text-tertiary">{t("admin.page.organizations.slug_label")}</h4>
            ...
            <Controller
              ...
              render={({ field: { onChange, value, ref } }) => (
                <Input
                  ...
                  placeholder={t("admin.page.organizations.slug_placeholder")}
        ...
        <div className="flex flex-col gap-1">
          <h4 className="text-13 text-tertiary">{t("admin.page.organizations.company_size")}</h4>
          <div className="w-full">
            <Controller
              name="organization_size"
              control={control}
              rules={{ required: t("admin.common.required") }}
                ...
                <CustomSelect
                  ...
                  label={
                    ORGANIZATION_SIZE.find((c) => c === value) ?? (
                      <span className="text-placeholder">{t("admin.common.search")}</span>
                    )
                  }
      ...
      <div className="flex max-w-4xl items-center gap-4 py-1">
        ...
        >
          {isSubmitting ? t("admin.common.saving") : t("admin.page.organizations.create_button")}
        </Button>
        <Link className={getButtonStyling("secondary", "lg")} href="/organizations">
          {t("admin.common.back")}
        </Link>
      </div>
    </div>
