...
import { ArchiveIcon, CycleIcon, ModuleIcon, WorkItemsIcon } from "@qlcv/propel/icons";
      ...
      <Header.LeftItem>
        <div className="flex items-center gap-2.5">
          ...
          {activeTab === "issues" && issueCount && issueCount > 0 ? (
            <Tooltip
              isMobile={isMobile}
              tooltipContent={`There are ${issueCount} ${issueCount > 1 ? "tasks" : "task"} in department's archived`}
              position="bottom"
            >
