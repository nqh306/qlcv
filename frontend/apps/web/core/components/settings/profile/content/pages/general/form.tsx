...
import type { IUser, TUserProfile } from "@qlcv/types";
...
// utils
import { validatePersonName, validateDisplayName } from "@qlcv/utils";
...
export const GeneralProfileSettingsForm = observer(function GeneralProfileSettingsForm(props: Props) {
  ...
  const {
    ...
    defaultValues: {
      ...
      email: user.email || "",
      role: profile.role || "Product / Department Manager",
