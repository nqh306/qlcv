...
import { IconButton, getIconButtonStyling } from "@qlcv/propel/icon-button";
import {
  LinkIcon,
  NewTabIcon,
  TrashIcon,
...
} from "@qlcv/propel/icons";
import type { TNameDescriptionLoader } from "@qlcv/types";

import { Header, CustomMenu, EHeaderVariant } from "@qlcv/ui";
import { cn, findHowManyDaysLeft, generateWorkItemLink } from "@qlcv/utils";
// components
              ...
              <CustomMenu.MenuItem
                onClick={() =>
                  handleActionWithPermission(
                    isProjectAdmin,
                    handleIssueSnoozeAction,
                    "Only department admins can snooze/Un-snooze tasks"
                  )
                }
              >
                <div className="flex items-center gap-2">
              ...
              <CustomMenu.MenuItem
                onClick={() =>
                  handleActionWithPermission(
                    ...
                    "Only department admins can mark tasks as duplicate"
                  )
                }
              >
                <div className="flex items-center gap-2">
              ...
              <CustomMenu.MenuItem
                onClick={() =>
                  handleActionWithPermission(
                    ...
                    "Only department admins can accept tasks"
                  )
                }
              >
              ...
              <CustomMenu.MenuItem
                onClick={() =>
                  handleActionWithPermission(
                    ...
                    "Only department admins can deny tasks"
                  )
                }
              >
