...
import { EInboxIssueStatus } from "@qlcv/types";
import { ControlLink, CustomMenu, Row } from "@qlcv/ui";
import { copyUrlToClipboard, findHowManyDaysLeft, generateWorkItemLink } from "@qlcv/utils";
// components
                      ...
                      <CustomMenu.MenuItem
                        onClick={() =>
                          handleActionWithPermission(
                            ...
                            "Only department admins can mark task as duplicate"
                          )
                        }
                      >
                        <div className="flex items-center gap-2">
