...
export default {
  aria_labels: {
    projects_sidebar: {
      ...
      open_workspace_switcher: "Mở trình chuyển đổi đơn vị",
      ...
      create_new_project: "Tạo phòng ban mới",
      open_projects_menu: "Mở menu phòng ban",
      close_projects_menu: "Đóng menu phòng ban",
      toggle_quick_actions_menu: "Bật/tắt menu hành động nhanh",
      open_project_menu: "Mở menu phòng ban",
      close_project_menu: "Đóng menu phòng ban",
