...
export default {
  ...
  auth: {
    common: {
      ...
      new_to_qlcv: "Lần đầu sử dụng QLCV?",
  ...
  support: "Hỗ trợ",
  forum: "Forum",
  powered_by_qlcv_pages: "Được hỗ trợ bởi QLCV Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        title: "Tạo phòng ban",
        description: "Trong QLCV, hầu hết mọi thứ đều bắt đầu từ phòng ban.",
        cta: "Bắt đầu",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Cá nhân hóa QLCV cho bạn",
  ...
  workspace_creation: {
    ...
    subheading: "Để bắt đầu với QLCV, bạn cần tạo hoặc tham gia một đơn vị.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Chào mừng đến với QLCV, chúng tôi rất vui khi bạn ở đây. Tạo phòng ban đầu tiên của bạn và theo dõi công việc, trang này sẽ trở thành không gian giúp bạn tiến triển. Quản trị viên cũng sẽ thấy phòng ban giúp nhóm tiến triển.",
        primary_button: {
          text: "Xây dựng phòng ban đầu tiên của bạn",
          comic: {
            title: "Trong QLCV, mọi thứ đều bắt đầu với phòng ban",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Sao chép và lưu khóa này trong QLCV Pages. Bạn sẽ không thể thấy khóa này sau khi đóng. Tệp CSV chứa khóa đã được tải xuống.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          title: "Xóa token API",
          description:
            "Bất kỳ ứng dụng nào sử dụng token này sẽ không thể truy cập dữ liệu QLCV nữa. Hành động này không thể hoàn tác.",
          success: {
            title: "Thành công!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "API QLCV có thể được sử dụng để tích hợp dữ liệu QLCV của bạn với bất kỳ hệ thống bên ngoài nào. Tạo token để bắt đầu.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Bắt đầu bằng cách tạo công việc mới! Thêm chi tiết và thuộc tính cho nó. Khám phá thêm trong QLCV để xem hoạt động của bạn.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "QLCV sẽ tự động lưu trữ các công việc đã hoàn thành hoặc đã hủy.",
        duration: "Tự động lưu trữ đã đóng",
      },
      "auto-close": {
        title: "Tự động đóng công việc",
        description: "QLCV sẽ tự động đóng các công việc chưa hoàn thành hoặc hủy.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Công việc là khối xây dựng cơ bản trong QLCV.",
            description:
              "Thiết kế lại giao diện QLCV, định vị lại thương hiệu công ty hoặc ra mắt hệ thống phun nhiên liệu mới đều là ví dụ về công việc có thể chứa các công việc con.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title: "Viết ghi chú, tài liệu hoặc cơ sở kiến thức đầy đủ. Để trợ lý AI Galileo của QLCV giúp bạn bắt đầu",
        description:
          "Trang là không gian ghi lại suy nghĩ trong QLCV. Ghi lại các ghi chú cuộc họp, định dạng dễ dàng, nhúng công việc, sử dụng thư viện thành phần để bố cục và lưu tất cả trong ngữ cảnh phòng ban. Để hoàn thành nhanh bất kỳ tài liệu nào, bạn có thể gọi AI Galileo của QLCV thông qua phím tắt hoặc nhấp nút.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    qlcv_didnt_start_up_this_could_be_because_one_or_more_qlcv_services_failed_to_start:
      "QLCV không khởi động được. Điều này có thể do một hoặc nhiều dịch vụ QLCV không khởi động được.",
  ...
  power_k: {
    contextual_actions: {
      work_item: {
        ...
        change_priority: "Đổi mức độ ưu tiên",
        change_assignees: "Giao cho",
        assign_to_me: "Giao cho tôi",
        unassign_from_me: "Bỏ giao cho tôi",
        change_estimate: "Đổi ước lượng",
        add_to_cycle: "Thêm vào chu kỳ",
        add_to_modules: "Thêm vào nhóm",
        add_labels: "Thêm nhãn",
        subscribe: "Đăng ký nhận thông báo",
        unsubscribe: "Hủy đăng ký nhận thông báo",
        delete: "Xóa",
        copy_id: "Sao chép ID",
        copy_id_toast_success: "Đã sao chép ID công việc vào clipboard.",
        copy_id_toast_error: "Có lỗi khi sao chép ID công việc vào clipboard.",
        copy_title: "Sao chép tiêu đề",
        copy_title_toast_success: "Đã sao chép tiêu đề công việc vào clipboard.",
        copy_title_toast_error: "Có lỗi khi sao chép tiêu đề công việc vào clipboard.",
        copy_url: "Sao chép URL",
        copy_url_toast_success: "Đã sao chép URL công việc vào clipboard.",
        copy_url_toast_error: "Có lỗi khi sao chép URL công việc vào clipboard.",
      },
      cycle: {
        title: "Hành động chu kỳ",
        indicator: "Chu kỳ",
        add_to_favorites: "Thêm vào yêu thích",
        remove_from_favorites: "Bỏ khỏi yêu thích",
        copy_url: "Sao chép URL",
        copy_url_toast_success: "Đã sao chép URL chu kỳ vào clipboard.",
        copy_url_toast_error: "Có lỗi khi sao chép URL chu kỳ vào clipboard.",
      },
      module: {
        title: "Hành động nhóm",
        indicator: "Nhóm",
        add_remove_members: "Thêm/bỏ thành viên",
        change_status: "Đổi trạng thái",
        add_to_favorites: "Thêm vào yêu thích",
        remove_from_favorites: "Bỏ khỏi yêu thích",
        copy_url: "Sao chép URL",
        copy_url_toast_success: "Đã sao chép URL nhóm vào clipboard.",
        copy_url_toast_error: "Có lỗi khi sao chép URL nhóm vào clipboard.",
      },
      page: {
        title: "Hành động trang",
        indicator: "Trang",
        lock: "Khóa",
        unlock: "Mở khóa",
        ...
        remove_from_favorites: "Bỏ khỏi yêu thích",
        copy_url: "Sao chép URL",
        copy_url_toast_success: "Đã sao chép URL trang vào clipboard.",
        copy_url_toast_error: "Có lỗi khi sao chép URL trang vào clipboard.",
      },
    },
    creation_actions: {
      create_work_item: "Công việc mới",
      create_page: "Trang mới",
      create_view: "Chế độ xem mới",
      create_cycle: "Chu kỳ mới",
      create_module: "Nhóm mới",
      create_project: "Phòng ban mới",
      create_workspace: "Đơn vị mới",
    },
    navigation_actions: {
      open_workspace: "Mở một đơn vị",
      nav_home: "Tới trang chủ",
      nav_inbox: "Tới hộp thư",
      nav_your_work: "Tới công việc của tôi",
      nav_account_settings: "Tới cài đặt tài khoản",
      open_project: "Mở một phòng ban",
      nav_projects_list: "Tới danh sách phòng ban",
      nav_all_workspace_work_items: "Tới tất cả công việc",
      nav_assigned_workspace_work_items: "Tới công việc được giao",
      nav_created_workspace_work_items: "Tới công việc đã tạo",
      nav_subscribed_workspace_work_items: "Tới công việc đã đăng ký",
      nav_workspace_analytics: "Tới phân tích đơn vị",
      nav_workspace_drafts: "Tới bản nháp đơn vị",
      nav_workspace_archives: "Tới lưu trữ đơn vị",
      open_workspace_setting: "Mở cài đặt đơn vị",
      nav_workspace_settings: "Tới cài đặt đơn vị",
      nav_project_work_items: "Tới công việc",
      open_project_cycle: "Mở một chu kỳ",
      nav_project_cycles: "Tới chu kỳ",
      open_project_module: "Mở một nhóm",
      nav_project_modules: "Tới các nhóm",
      open_project_view: "Mở một chế độ xem phòng ban",
      nav_project_views: "Tới chế độ xem phòng ban",
      nav_project_pages: "Tới các trang",
      nav_project_intake: "Tới tiếp nhận",
      nav_project_archives: "Tới lưu trữ phòng ban",
      open_project_setting: "Mở cài đặt phòng ban",
      nav_project_settings: "Tới cài đặt phòng ban",
    },
    account_actions: {
      sign_out: "Đăng xuất",
      workspace_invites: "Lời mời đơn vị",
    ...
    miscellaneous_actions: {
      ...
      copy_current_page_url_toast_success: "Đã sao chép URL trang hiện tại vào clipboard.",
      copy_current_page_url_toast_error: "Có lỗi khi sao chép URL trang hiện tại vào clipboard.",
      focus_top_nav_search: "Tới ô tìm kiếm",
    },
    preferences_actions: {
    ...
    help_actions: {
      open_keyboard_shortcuts: "Mở phím tắt bàn phím",
      open_qlcv_documentation: "Mở tài liệu",
      join_forum: "Tham gia diễn đàn",
      report_bug: "Báo lỗi",
    ...
    page_placeholders: {
      ...
      update_work_item_priority: "Đổi mức độ ưu tiên",
      update_work_item_assignee: "Giao cho",
      update_work_item_estimate: "Đổi ước lượng",
      update_work_item_cycle: "Thêm vào chu kỳ",
      update_work_item_module: "Thêm vào nhóm",
