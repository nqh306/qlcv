...
export const SITE_DESCRIPTION =
  "Open-source task management tool to manage tasks, cycles, and product roadmaps easily";
export const SITE_KEYWORDS =
  "software development, plan, ship, software, accelerate, code management, release management, task management, tasks tracking, agile, scrum, kanban, collaboration";
...
export const SPACE_SITE_KEYWORDS =
  "software development, customer feedback, software, accelerate, code management, release management, task management, tasks tracking, agile, scrum, kanban, collaboration";
